...
const testAssignments = {
  adminActiveCommunityReport: { constant: "ADMIN_ACTIVE_COMMUNITY_REPORT_TEMPLATE", test: "admin-active-community-report", keys: {
    "production": {
  ...
  adminCommunityCreated: { constant: "ADMIN_COMMUNITY_CREATED_TEMPLATE", test: "admin-community-created-notification", keys: {
  ...
  adminSlackImportProcessed: { constant: "ADMIN_SLACK_IMPORT_PROCESSED_TEMPLATE", test: "admin-slack-import-completed", keys: {
    "production": {
  ...
  adminToxicContent: { constant: "ADMIN_TOXIC_MESSAGE_TEMPLATE", test: "admin-toxic-content", keys: {
    "production": {
  ...
  adminUserReported: { constant: "ADMIN_USER_REPORTED_TEMPLATE", test: "admin-user-reported-alert", keys: {
    "production": {
  ...
  adminUserSpammingThreadsNotification: { constant: "ADMIN_USER_SPAMMING_THREADS_NOTIFICATION_TEMPLATE", test: "admin-user-spamming-threads-alert", keys: {
    "production": {
  ...
  communityInvite: { constant: "COMMUNITY_INVITE_TEMPLATE", test: "community-invitation", keys: {
    "test": {
  ...
  mentionInMessage: { constant: "NEW_MENTION_MESSAGE_TEMPLATE", test: "mention-in-message", keys: {
    "test": {
  ...
  mentionInThread: { constant: "NEW_MENTION_THREAD_TEMPLATE", test: "mention-in-thread", keys: {
    "test": {
  ...
  newCommunityWelcome: { constant: "NEW_COMMUNITY_WELCOME_TEMPLATE", test: "", keys: {
    "test": {
  ...
  newDirectMessage: { constant: "NEW_DIRECT_MESSAGE_TEMPLATE", test: "", keys: {
    "test": {
  ...
  newRepliesInThreads: { constant: "NEW_MESSAGE_TEMPLATE", test: "", keys: {
    "test": {
  ...
  newThreadNotification: { constant: "NEW_THREAD_CREATED_TEMPLATE", test: "", keys: {
    "test": {
  ...
  newUserWelcome: { constant: "NEW_USER_WELCOME_TEMPLATE", test: "new-user-welcome", keys: {
    "test": {
  ...
  privateChannelRequestApproved: { constant: "PRIVATE_CHANNEL_REQUEST_APPROVED_TEMPLATE", test: "private-channel-request-approved", keys: {
    "test": {
  ...
  privateChannelRequestSent: { constant: "PRIVATE_CHANNEL_REQUEST_SENT_TEMPLATE", test: "private-channel-request-sent", keys: {
    "test": {
  ...
  privateCommunityRequestApproved: { constant: "PRIVATE_COMMUNITY_REQUEST_APPROVED_TEMPLATE", test: "private-community-request-approved", keys: {
    "test": {
  ...
  privateCommunityRequestSent: { constant: "PRIVATE_COMMUNITY_REQUEST_SENT_TEMPLATE", test: "private-community-request-sent", keys: {
    "test": {
  ...
  "validate-community-administrator-email": { constant: "ADMINISTRATOR_EMAIL_VALIDATION_TEMPLATE", test: "community-admin-email-validation", keys: {
    "test": {
  ...
  "validate-email": { constant: "EMAIL_VALIDATION_TEMPLATE", test: "user-email-validation", keys: {
    "test": {
  ...
  weeklyDigest: { constant: "DIGEST_TEMPLATE", test: "digest", keys: {
    "test": {
